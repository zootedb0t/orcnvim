...
function M.statusline_highlight()
  ...
  highlight(0, "StatuslineInsertAccent", { fg = "#313244", bg = "#CBA6F7", bold = true })
  highlight(0, "StatuslineVisualAccent", { fg = "#313244", bg = "#F38BA8", bold = true })
  highlight(0, "StatuslineReplaceAccent", { fg = "#313244", bg = "#89B4FA", bold = true })
  highlight(0, "StatuslineTerminalAccent", { fg = "#313244", bg = "#F9E2AF", bold = true })
  highlight(0, "StatuslineCmdLineAccent", { fg = "#313244", bg = "#74C7EC", bold = true })
